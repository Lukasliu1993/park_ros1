...
#ifndef __WANJI_CALIBRATION_H
#define __WANJI_CALIBRATION_H
 ...
 * Wanji).  Includes parameters for Wanji HDL-64E S2.1.
 *
 * http://wanjilidar.com/lidar/products/manual/63-HDL64E%20S2%20Manual_Rev%20D_2011_web.pdf
 */
...
#endif /* end of include guard: __WANJI_CALIBRATION_H */
