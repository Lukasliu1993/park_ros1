...
private:
  ...
  boost::shared_ptr<wanjiDriver> dvr_;  ///< driver implementation class
};

void DriverNodelet::onInit()
{
  // start the driver
  dvr_.reset(new wanjiDriver(getNodeHandle(), getPrivateNodeHandle()));
...
PLUGINLIB_EXPORT_CLASS(wanji_driver::DriverNodelet, nodelet::Nodelet)
